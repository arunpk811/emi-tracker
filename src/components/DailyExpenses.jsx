...
export default function DailyExpenses() {
    ...
    const categories = {
        Expense: ['Food', 'Daily', 'Health', 'Toys', 'Skincare', 'Digital Subscription', 'Business', 'Rotation', 'Other Expenses'],
        Income: ['Daily Income', 'Business', 'Borrow', 'Rotation', 'Other Income']
    };
